...
class Orders extends ResourceObject
{
    ...
    public function onGet(
        int|null $id = null,
        int|null $order_status_id = null,
        string|null $order_no = null,
        string|null $customer_email = null,
        string|null $from_date = null,
        string|null $to_date = null,
        int $limit = 20,
        int $offset = 0,
    ): static {
        if ($id !== null) {
            ...
            if ($order_status_id !== null) {
                $filters['order_status_id'] = $order_status_id;
            }
    ...
    #[RequireAuth(role: 'admin')]
    public function onPut(int $id, int $order_status_id, string|null $note = null): static
    {
        $order = $this->orderQuery->findById($id);
        if ($order === null) {
            $this->code = 404;
