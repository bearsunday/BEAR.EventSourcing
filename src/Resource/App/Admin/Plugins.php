...
class Plugins extends ResourceObject
{
    ...
    #[RequireAuth(role: 'admin')]
    public function onPost(string $name, string $code, string $version = '1.0.0', string|null $source = null): static
    {
    ...
    #[RequireAuth(role: 'admin')]
    public function onPut(int $id, bool|null $enabled = null, string|null $version = null): static
    {
        $plugin = $this->query->findById($id);
        if ($plugin === null) {
            $this->code = 404;
