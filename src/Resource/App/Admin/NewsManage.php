...
class NewsManage extends ResourceObject
{
    ...
    public function onGet(int|null $id = null, int $limit = 20, int $offset = 0): static
    {
        if ($id !== null) {
    ...
    public function onPut(
        ...
        string|null $comment = null,
        string|null $url = null,
        bool|null $link_method = null,
        string|null $publish_date = null,
        ...
        if ($link_method !== null) {
            $data['link_method'] = $link_method ? 1 : 0;
        }
