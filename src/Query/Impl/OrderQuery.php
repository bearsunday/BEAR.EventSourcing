...
class OrderQuery implements OrderQueryInterface
{
    ...
    public function findAll(int|null $customerId = null, int|null $status = null, string|null $orderNo = null, string|null $dateFrom = null, string|null $dateTo = null, int $limit = 20, int $offset = 0): array
    {
    ...
    public function count(int|null $customerId = null, int|null $status = null, string|null $orderNo = null, string|null $dateFrom = null, string|null $dateTo = null): int
    {
    ...
    {
        return $this->pdo->fetchOne('SELECT * FROM `order` WHERE id = :id', ['id' => $id]) ?: null;
    }

    public function findByOrderNo(string $orderNo): array|null
    {
        return $this->pdo->fetchOne('SELECT * FROM `order` WHERE order_no = :order_no', ['order_no' => $orderNo]) ?: null;
    }
    ...
    {
        $this->update($id, ['order_status_id' => OrderStatus::CANCEL]);
    }
}
