 ...
 *
 * A filtered key keeps its place and loses only its value, and withholding one does not
 * automatically mean the request became non-replayable — see {@see FilteredParams} for the
 * transport/credential distinction that decides it.
 */
