...
/**
 * onPost() performs a nested inventory write through the same invoker, so the
 * observation log records a parent -> child request tree.
 */
final class Orders extends ResourceObject
{
    ...
    {
        // A failed state change: observed in the log, never extracted as an event.
        $this->code = 409;
